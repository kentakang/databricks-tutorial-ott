...
자원 이름과 기존 Warehouse 예외는 [docs/RESOURCE_NAMING.md](docs/RESOURCE_NAMING.md), 제품·아키텍처 결정은 [docs/IDEATION.md](docs/IDEATION.md)와 [docs/adr/0001-consumer-ott-app-architecture.md](docs/adr/0001-consumer-ott-app-architecture.md)에 기록되어 있습니다.
